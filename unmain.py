...
3. Overwrite the first comment with the second
4. Keep the first comment and delete the second
                ...
                if user_input == "1":
                    ...
                    logger.debug("Keeping the second comment and deleting the first")
                    lines[existing_line - 1] = ""
                    todo_comments[match.group(1)] = (match.group(2), index + 1)

                elif user_input == "4":
                    logger.debug("Keeping the first comment and deleting the second")
                    lines[index] = ""
